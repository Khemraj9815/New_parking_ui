...
import { LayoutDashboard, LogOut, Settings, UserPlus, Car, MapPin, ParkingCircle, RectangleVertical } from "lucide-react";
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="p-6 flex-1">
            ...
            <div className="mt-4">
              ...
              <img src="http://localhost:5000/video_feed" alt="Live Feed" className="w-full h-96 bg-black" />
